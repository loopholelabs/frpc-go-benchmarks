...
type BenchmarkServiceClient interface {
	Benchmark(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *benchmarkServiceClient) Benchmark(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/BenchmarkService/Benchmark", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBenchmarkServiceServer) Benchmark(context.Context, *Request) (*Response, error) {
...
func _BenchmarkService_Benchmark_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BenchmarkServiceServer).Benchmark(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/BenchmarkService/Benchmark",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BenchmarkServiceServer).Benchmark(ctx, req.(*Request))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _BenchmarkService_Benchmark_Handler,
		},
	},
